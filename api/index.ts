...
// Lazy / cached Gemini SDK client factory (safe for serverless cold-starts & dynamic env injection)
...
function getGeminiClient(): GoogleGenAI | null {
  ...
  if (!aiClientInstance || lastApiKey !== apiKey) {
...
// Create API router with identical business and AI logic
...
// Mount router ONLY at "/api"
app.use("/api", apiRouter);

// Export Express app for Vercel serverless functions (does NOT call app.listen())
export default app;
export { app };
